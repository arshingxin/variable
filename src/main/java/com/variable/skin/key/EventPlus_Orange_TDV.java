 ...
 * @author Star
 */
public class EventPlus_Orange_TDV {
    //黑色
    ...
    public static int DEFAULT_COLOR=0xffE77918;
    public static int SEND_MESSAGE_TITLE_BG=0xffE77918;
    ...
    public static int REPLY_HEADER_BG = 0xffE68936;
    public static int REPLY_BOTTOM_BG = 0xffE77918;
    public static int LOADING_LAYOUT_BG = 0xccE77918;
    ...
    public static int SETTING_BG_SWITCH_ON = R.drawable.bg_orange_switch_on;
    public static int SETTING_BG_SWITCH_OFF = R.drawable.bg_orange_switch_off;
    public static int SETTING_THUMB_SWITCH = R.drawable.icon_white_solid_circle;
    public static int CUSTOM_TOAST_BG = 0xcc595959;
    public static int CUSTOM_TOAST_ICON = R.drawable.csicon_orange;
    public static int CREATE_VOTE_VOTE_BUTTON = R.drawable.button_orange_frame_white_normal;
    ...
    //橘色按鈕
    public static int W03= R.drawable.button_orange;
    //綠按鈕
    ...
    //白色按鈕、橘色框
    public static int W08=R.drawable.button_orange_frame_white;
    //白色按鈕、藍色框
